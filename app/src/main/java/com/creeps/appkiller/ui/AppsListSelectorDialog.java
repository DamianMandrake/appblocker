...
public class AppsListSelectorDialog extends android.support.v4.app.DialogFragment {
    ...
    public static AppsListSelectorDialog getInstance(String profileName,Activity baseActivity,AppsListSelectorDialogCallback callback){
    ...
    public Dialog onCreateDialog(Bundle savedInstance){
        ...
        this.adapter=new AppListRecyclerAdapter(baseActivity, (ArrayList<UsageStats>) ProcessLister.getUsageAccessData(baseActivity,true));
        ...
        alertDialog.setPositiveButton("DONE", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if(selected.size()>0){
                    //todo change this to actual time obtained from ClockHandler
                    DatabaseHandler db=DatabaseHandler.getInstance(baseActivity);
                    long id=db.addProfile(profileName,123,345);
